                 ...
                 <div class="span8">
                    <div class="posts">
                       ...
                       <div class="entry">
                          ...
                          <!-- Meta details -->
                          <div class="meta">
                             <i class="icon-calendar"></i> <?php echo date('d M Y',strtotime($loker->tanggal_akhir)); ?> <i class="icon-folder-open"></i> <a href="<?php echo site_url('home/keahlian/'.$loker->id.'/'.url_title(strtolower($loker->keahlian))); ?>"><?php echo $loker->keahlian; ?></a> <span class="pull-right"><i class="icon-comment"></i> <a href="#disqus_thread"> Comments</a></span>
                          </div>                                                   
